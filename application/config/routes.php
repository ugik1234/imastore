...
$route['checkout'] = 'PublicController/checkout';
$route['delivery'] = 'PublicController/delivery';
$route['payment'] = 'PublicController/payment';
$route['invoice'] = 'PublicController/invoice';
$route['invoice/s'] = 'PublicController/invoiceopen';
