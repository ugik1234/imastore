                            ...
                            <div class="login-block login-block-signup">
                                ...
                                <form id="registerForm" class="m-t" role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" id="nama" name="nama" placeholder="Name: *">
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" id="company_name" name="company_name" placeholder="Company name: *">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" id="username" name="username" placeholder="Username: *" required>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" name="zip_code" placeholder="Zip code: *">
                                            </div>
                                        </div>

                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" name="alamat" placeholder="City: *">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" value="" class="form-control" id="no_telp" name="no_telp" placeholder="Phone: *">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="password" placeholder="Re-Password" class="form-control" id="repassword" name="repassword" autocomplete="new-password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <button href="#" id="registerBtn" class="btn btn-main btn-block">Create account</button>
                                        </div>
