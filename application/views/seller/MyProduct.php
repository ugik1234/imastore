            ...
            <div class="popup-table">
                ...
                <div class="popup-cell">
                    <div class="popup-buttons">
                        ...
                        <a id="link-edit-product" href="javascript:void(0);"><span class="icon icon-pencil"></span> <span class="hidden-xs">Edit</span></a>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        var popup = {
            ...
            'edit': $('#productid1').find('#link-edit-product'),
        ...
        function renderProduct(data) {
                ...
                <div class="col-xs-6 col-sm-4 col-lg-3">
                    <article>
                        <div class="info">
                         ...
                         <a class="btn btn-add" href="<?= site_url('Seller/editproduct/?s='); ?>${product['id_product']}">   <i class="icon icon-pencil active"></i> </a>
                        <div class="figure-grid">
            ...
            $('.mfp-open').on('click', function() {
                ...
                popup.edit.prop('href','<?= site_url('Seller/editproduct/?s='); ?>'+currentData['id_product'])
