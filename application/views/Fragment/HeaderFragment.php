...
<head>
    ...
    <!--Title-->
    <title>Store PT INDOMETAL ASIA</title>
...
<body id="page-top" class="landing-page no-skin-config">
    ...
    <div class="wrapper">
        ...
        <nav>
            <div class="clearfix">
                <a href="<?= base_url() ?>" class="logo"><img src="<?= base_url() ?>assets/images/ima-transparent2.png" style="max-width : 400px; padding: 5px" alt="" /></a>
